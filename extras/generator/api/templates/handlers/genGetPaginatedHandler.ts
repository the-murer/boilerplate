...
import { Get${entity.pluralPascal()}Handler as Handler } from "@/api/${entity.camelCase()}/serializers/get${entity.pascalCase()}sSerializer";
...
export const get${entity.pluralPascal()}Handler: Handler = async ({
  page,
  limit,
  sortField,
  sortOrder,
